...
let workoutData = {
    PUSH: [
        ...
        { name: 'Supino Plano na Máquina', sets: 3 },
        { name: 'Press Militar c/ Halteres', sets: 3 },
        { name: 'Elevações Laterais na Polia', sets: 4 },
        { name: 'Tríceps à Testa', sets: 3 },
    ...
    PULL: [
        ...
        { name: 'Curl de Bíceps Inclinado', sets: 3 },
        { name: 'Curl Martelo', sets: 3 }
    ],
    LEGS: [
    ...
    MOBILITY: [
        ...
        { name: 'Cão Olhando para Baixo', sets: 2, reps: '45s' },
        { name: 'Ponte de Glúteos', sets: 2, reps: '15 reps' }
    ],
    CUSTOM: []
};
...
const exerciseLibrary = [
    ...
    { name: "Supino Plano na Máquina", muscle: "Peito", tier: "A", type: "machine", defaultSets: 3 },
    ...
    { name: "Pullover com Haltere", muscle: "Costas", tier: "B", type: "free", defaultSets: 3 },
    { name: "Agachamento Livre", muscle: "Pernas", tier: "S", type: "free", defaultSets: 3 },
    { name: "Agachamento Hack", muscle: "Pernas", tier: "A", type: "machine", defaultSets: 3 },
    ...
    { name: "Extensão de Pernas", muscle: "Pernas", tier: "A", type: "machine", defaultSets: 3 },
    ...
    { name: "Elevação de Gémeos Sentado", muscle: "Pernas", tier: "B", type: "machine", defaultSets: 4 },
    ...
    { name: "Elevações Laterais c/ Halteres", muscle: "Ombros", tier: "A", type: "free", defaultSets: 4 },
    ...
    { name: "Curl Martelo", muscle: "Braços", tier: "A", type: "free", defaultSets: 3 },
    { name: "Curl de Bíceps na Polia", muscle: "Braços", tier: "B", type: "machine", defaultSets: 3 },
    ...
    { name: "Crunch Abdominal na Polia", muscle: "Core", tier: "A", type: "machine", defaultSets: 3 },
    { name: "Elevação de Pernas em Suspensão", muscle: "Core", tier: "S", type: "free", defaultSets: 3 },
    { name: "Prancha Abdominal (Plank)", muscle: "Core", tier: "A", type: "free", defaultSets: 3 }
];
...
const recipesDB = [
    ...
    { name: "Arroz de Frango Anabólico", type: "Pós-Treino", cals: 600, pro: 50, desc: "150g peito de frango, 100g arroz basmati, brócolos." },
    ...
    { name: "Omolete de Claras Rápida", type: "Ceia", cals: 200, pro: 25, desc: "200ml claras, 1 ovo inteiro, espinafres." },
